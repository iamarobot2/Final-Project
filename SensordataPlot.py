...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.timer.timeout.connect(self.update_plot_data)  # call update_plot_data function every 10 milisec
        self.timer.start()
...
sensor = Sensor(address="192.168.134.97:8080", sensor_type="android.sensor.accelerometer")
